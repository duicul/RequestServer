...
public abstract class HTMLHelperIn implements HTMLHelper{
	...
	public HTMLHelperIn(int uid,int pin_no,String name,String sensor,Timestamp timestamp,boolean active) {
		this.pin_no=pin_no;
		this.sensor=sensor;
